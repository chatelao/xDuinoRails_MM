...
void test_motor_pwm_mapping_new_defaults(void) {
  CvManagerMock cvManager;
  // Use new standard default values:
  // CV_START_VOLTAGE = 1 (Vstart = 4)
  // CV_MAXIMUM_SPEED = 255 (Vhigh = 1023)
  // CV_MEDIUM_SPEED = 127 (Vmid = 509)
  ...
  TEST_ASSERT_EQUAL(0, get_pwm(0));
  TEST_ASSERT_EQUAL(4, get_pwm(1));
  TEST_ASSERT_EQUAL(88, get_pwm(2));
  TEST_ASSERT_EQUAL(172, get_pwm(3));
  TEST_ASSERT_EQUAL(256, get_pwm(4));
  TEST_ASSERT_EQUAL(340, get_pwm(5));
  TEST_ASSERT_EQUAL(424, get_pwm(6));
  TEST_ASSERT_EQUAL(509, get_pwm(7));
  TEST_ASSERT_EQUAL(582, get_pwm(8));
  TEST_ASSERT_EQUAL(655, get_pwm(9));
  TEST_ASSERT_EQUAL(729, get_pwm(10));
  TEST_ASSERT_EQUAL(802, get_pwm(11));
  TEST_ASSERT_EQUAL(876, get_pwm(12));
  TEST_ASSERT_EQUAL(949, get_pwm(13));
  TEST_ASSERT_EQUAL(1023, get_pwm(14));
}
